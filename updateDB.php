<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('missions', "create table if not exists `missions` (   `id_mission` INT unsigned not null auto_increment , primary key (`id_mission`), `id_consultant` INT unsigned null , `rattache_a_filiere` INT unsigned null , `site_mission` VARCHAR(64) null , `periode` VARCHAR(40) null , `date_debut` DATE null , `date_fin` DATE null , `description_mission` TEXT not null , `description_detaille` TEXT null , `client` INT unsigned null , `environnement` VARCHAR(254) null , `competences_utilisees` INT unsigned null , `tags` TEXT null ) CHARSET utf8", $silent, array( "ALTER TABLE missions ADD `field13` VARCHAR(40)","ALTER TABLE `missions` CHANGE `field13` `tags` VARCHAR(40) null "," ALTER TABLE `missions` CHANGE `tags` `tags` TEXT null "));
		setupIndexes('missions', array('id_consultant','rattache_a_filiere','client','competences_utilisees'));
		setupTable('competences_individuelles', "create table if not exists `competences_individuelles` (   `id_comp_indiv` INT unsigned not null auto_increment , primary key (`id_comp_indiv`), `Competences_specifiques` VARCHAR(40) null , `competence_mis_en_oeuvre` INT unsigned not null , `niveau` INT unsigned not null , `consultant_id` INT unsigned not null , `Documents_capitalises` VARCHAR(40) null , `commentaires` TEXT null , `tags` TEXT null ) CHARSET utf8", $silent, array( "ALTER TABLE `competences_individuelles` DROP `rattache_a_mission`","ALTER TABLE competences_individuelles ADD `field7` VARCHAR(40)","ALTER TABLE `competences_individuelles` CHANGE `field7` `Competences_specifiues` VARCHAR(40) null ","ALTER TABLE `competences_individuelles` CHANGE `Competences_specifiues` `Competences_specifiques` VARCHAR(40) null ","ALTER TABLE competences_individuelles ADD `field8` VARCHAR(40)","ALTER TABLE `competences_individuelles` CHANGE `field8` `tags` VARCHAR(40) null "," ALTER TABLE `competences_individuelles` CHANGE `tags` `tags` TEXT null "));
		setupIndexes('competences_individuelles', array('competence_mis_en_oeuvre','niveau','consultant_id'));
		...
		setupTable('tags', "create table if not exists `tags` (   `id` INT unsigned not null auto_increment , primary key (`id`), `tags` VARCHAR(40) null ) CHARSET utf8", $silent, array( "ALTER TABLE `table13` RENAME `tags`","UPDATE `membership_userrecords` SET `tableName`='tags' where `tableName`='table13'","UPDATE `membership_userpermissions` SET `tableName`='tags' where `tableName`='table13'","UPDATE `membership_grouppermissions` SET `tableName`='tags' where `tableName`='table13'","ALTER TABLE tags ADD `field1` VARCHAR(40)","ALTER TABLE `tags` CHANGE `field1` `id` VARCHAR(40) null ","ALTER TABLE `tags` CHANGE `id` `id` INT unsigned not null auto_increment ","ALTER TABLE tags ADD `field2` VARCHAR(40)","ALTER TABLE `tags` CHANGE `field2` `tags` VARCHAR(40) null "));
