<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('tags', "create table if not exists `tags` (   `id` INT unsigned not null auto_increment , primary key (`id`), `tags` VARCHAR(40) null ) CHARSET utf8", $silent);
