	...
	if(!function_exists('getTableList')) {
		function getTableList($skip_authentication = false) {
			$arrTables = array(
				...
				'competences_individuelles' => 'Vos Competences ',
				'client' => 'Client',
				'competences_ref' => 'R&#233;f&#233;rentiel des comp&#233;tences',
				'domaine' => 'Domaine',
				'filiere' => 'Filiere',
				'niveaux_ref' => 'Niveaux ref',
				'carriere_consultant' => 'Votre Carriere',
...
########################################################################
	...
	*/
	...
	function get_parent_tables($table) {
		...
		$parents = array(
			'consultant' => array(
				'consultant' => array('coache_par'),
				'emploi_fonctionnel' => array('emploi_fonctionnel'),
			),
			'missions' => array(
				'consultant' => array('id_consultant'),
			...
			'formation_suivi' => array(
				'competences_ref' => array('competence_secondaire'),
				'consultant' => array('consultant_id'),
			),
		);
