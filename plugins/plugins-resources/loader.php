<?php
	function load_plugins_resources(){
		...
		if( !@include("{$base_dir}/defaultLang.php") ) $plugins_error = true;
		if( !@include("{$base_dir}/language.php") ) $plugins_error = true;
		if( !@include("{$base_dir}/lib.php") ) $plugins_error = true;
		if( !@include("{$resources_dir}/ProgressLog.php") ) $plugins_error = true;
