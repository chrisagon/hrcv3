		...
		$pcConfig = array(
			...
			'missions' => array(   
				'id_consultant' => array(   
					...
					'sortable-fields' => array(0 => '`missions`.`id_mission`', 1 => 2, 2 => 3, 3 => '`missions`.`date_debut`', 4 => '`missions`.`date_fin`', 5 => 6, 6 => 7, 7 => '`client1`.`nom_du_client`'),
					'records-per-page' => 10,
					'default-sort-by' => 3,
				...
				'rattache_a_cv' => array(   
					...
					'child-primary-key' => 'id_mission',
					'child-primary-key-index' => 0,
					'tab-label' => 'Missions <span class="hidden child-label-missions child-field-caption">(Rattache au consultant)</span>',
					'auto-close' => false,
					'table-icon' => 'resources/table_icons/document_comment_above.png',
					'display-refresh' => true,
					'display-add-new' => true,
