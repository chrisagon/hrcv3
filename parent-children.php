		...
		$pcConfig = array(
			...
			'missions' => array(
				'id_consultant' => array(
					...
					'sortable-fields' => array(0 => '`missions`.`id_mission`', 1 => 2, 2 => '`filiere1`.`titre_filiere`', 3 => 4, 4 => 5, 5 => '`missions`.`date_debut`', 6 => '`missions`.`date_fin`', 7 => 8, 8 => 9, 9 => '`client1`.`nom_du_client`', 10 => 11, 11 => 12, 12 => '`tags1`.`tags`'),
					'records-per-page' => 10,
					'default-sort-by' => 5,
			...
			'competences_individuelles' => array(
				'consultant_id' => array(
					...
					'sortable-fields' => array(0 => '`competences_individuelles`.`id_comp_indiv`', 1 => 2, 2 => '`competences_ref1`.`titre_competence`', 3 => 4, 4 => 5, 5 => 6, 6 => 7, 7 => '`tags1`.`tags`'),
					'records-per-page' => 10,
