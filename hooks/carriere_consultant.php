<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'carriere_consultant' table. 
	...
	*/
	...
	function carriere_consultant_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function carriere_consultant_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function carriere_consultant_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['date_debut'], $data['date_fin'], $data['titre_emploi']
	...
	*/
	...
	function carriere_consultant_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function carriere_consultant_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function carriere_consultant_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_carriere_conslt'], $data['date_debut'], $data['date_fin'], $data['titre_emploi']
	...
	*/
	...
	function carriere_consultant_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function carriere_consultant_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function carriere_consultant_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function carriere_consultant_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function carriere_consultant_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function carriere_consultant_batch_actions(&$args){
