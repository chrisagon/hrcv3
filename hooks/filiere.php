<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'filiere' table. 
	...
	*/
	...
	function filiere_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function filiere_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function filiere_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre_filiere'], $data['description']
	...
	*/
	...
	function filiere_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function filiere_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function filiere_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_filiere'], $data['titre_filiere'], $data['description']
	...
	*/
	...
	function filiere_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function filiere_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function filiere_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function filiere_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function filiere_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function filiere_batch_actions(&$args){
