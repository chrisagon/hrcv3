<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'formation_suivi' table. 
	...
	*/
	...
	function formation_suivi_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function formation_suivi_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function formation_suivi_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['niveau'], $data['date_deb'], $data['date_fin'], $data['competence_principale'], $data['competence_secondaire'], $data['evaluation'], $data['consultant_id'], $data['organisme'], $data['commentaire']
	...
	*/
	...
	function formation_suivi_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function formation_suivi_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['titre'], $data['niveau'], $data['date_deb'], $data['date_fin'], $data['competence_principale'], $data['competence_secondaire'], $data['evaluation'], $data['consultant_id'], $data['organisme'], $data['commentaire']
	...
	*/
	...
	function formation_suivi_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function formation_suivi_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function formation_suivi_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function formation_suivi_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function formation_suivi_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function formation_suivi_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function formation_suivi_batch_actions(&$args){
