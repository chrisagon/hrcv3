<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'domaine' table. 
	...
	*/
	...
	function domaine_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function domaine_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function domaine_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre_domaine'], $data['description'], $data['rattache_a_filiere']
	...
	*/
	...
	function domaine_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function domaine_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function domaine_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_domaine'], $data['titre_domaine'], $data['description'], $data['rattache_a_filiere']
	...
	*/
	...
	function domaine_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function domaine_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function domaine_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function domaine_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function domaine_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function domaine_batch_actions(&$args){
