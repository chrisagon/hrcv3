...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="competences_individuelles_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/brick.png"> 					Competences individuelles Filters</a>
			</h1></div>
...
<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
	...
	<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Competence mis en oeuvre</label></div>
	<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Competence mis en oeuvre</label></div>
		...
		if ($j("#filterfield_2").val().length){
			...
			$j.ajax({
				...
				data: {
					...
					p: 1,                                         //page number
					t:"competences_individuelles",                //table name
					f:"competence_mis_en_oeuvre"               //field name
				}
...
<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
	...
	<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Niveau de la compétence</label></div>
	<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Niveau de la compétence</label></div>
...
<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
	...
	<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">detenu par</label></div>
	<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">detenu par</label></div>
...
<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
	...
	<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Rattache a la mission</label></div>
	<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Rattache a la mission</label></div>
	...
	$j(function(){
		...
		$j("#filter_4").select2({
			ajax: {
				...
				dataType: 'json',
				cache: true,
				data: function(term, page){ return { s: term, p:page, t:"competences_individuelles", f:"rattache_a" }; },
				results: function (resp, page) { return resp; }
			}
		}).on('change', function(e){
