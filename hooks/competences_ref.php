<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'competences_ref' table. 
	...
	*/
	...
	function competences_ref_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function competences_ref_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function competences_ref_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre_competence'], $data['description'], $data['domaine_principal'], $data['domaine']
	...
	*/
	...
	function competences_ref_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function competences_ref_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function competences_ref_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_competence'], $data['titre_competence'], $data['description'], $data['domaine_principal'], $data['domaine']
	...
	*/
	...
	function competences_ref_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function competences_ref_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function competences_ref_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function competences_ref_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function competences_ref_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function competences_ref_batch_actions(&$args){
