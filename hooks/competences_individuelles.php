<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'competences_individuelles' table. 
	...
	*/
	...
	function competences_individuelles_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function competences_individuelles_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function competences_individuelles_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['competence_mis_en_oeuvre'], $data['niveau'], $data['consultant_id'], $data['Documents_capitalises'], $data['commentaires']
	...
	*/
	...
	function competences_individuelles_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['rattache_a_mission'], $data['competence_mis_en_oeuvre'], $data['niveau'], $data['consultant_id'], $data['Documents_capitalises'], $data['commentaires']
	...
	*/
	...
	function competences_individuelles_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function competences_individuelles_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_comp_indiv'], $data['rattache_a_mission'], $data['competence_mis_en_oeuvre'], $data['niveau'], $data['consultant_id'], $data['Documents_capitalises'], $data['commentaires']
	...
	*/
	...
	function competences_individuelles_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function competences_individuelles_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function competences_individuelles_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function competences_individuelles_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function competences_individuelles_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function competences_individuelles_batch_actions(&$args){
