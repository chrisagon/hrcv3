<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'niveaux_ref' table. 
	...
	*/
	...
	function niveaux_ref_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function niveaux_ref_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function niveaux_ref_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['niveau'], $data['description']
	...
	*/
	...
	function niveaux_ref_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function niveaux_ref_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_niveau'], $data['titre'], $data['niveau'], $data['description']
	...
	*/
	...
	function niveaux_ref_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function niveaux_ref_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function niveaux_ref_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function niveaux_ref_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function niveaux_ref_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function niveaux_ref_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function niveaux_ref_batch_actions(&$args){
