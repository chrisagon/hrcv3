<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'competences' table. 
	...
	*/
	...
	function competences_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function competences_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function competences_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre_competence'], $data['description'], $data['rattache_a']
	...
	*/
	...
	function competences_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function competences_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function competences_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_competence'], $data['titre_competence'], $data['description'], $data['rattache_a']
	...
	*/
	...
	function competences_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function competences_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function competences_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function competences_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function competences_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function competences_batch_actions(&$args){
