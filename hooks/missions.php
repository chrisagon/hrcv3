<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'missions' table. 
	...
	*/
	...
	function missions_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function missions_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function missions_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['id_consultant'], $data['date_debut'], $data['date_fin'], $data['description_mission'], $data['description_detaille'], $data['client']
	...
	*/
	...
	function missions_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['id_consultant'], $data['rattache_a_cv'], $data['date_debut'], $data['date_fin'], $data['description_mission'], $data['description_detaille'], $data['client']
	...
	*/
	...
	function missions_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function missions_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_mission'], $data['id_consultant'], $data['rattache_a_cv'], $data['date_debut'], $data['date_fin'], $data['description_mission'], $data['description_detaille'], $data['client']
	...
	*/
	...
	function missions_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function missions_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function missions_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function missions_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function missions_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function missions_batch_actions(&$args){
