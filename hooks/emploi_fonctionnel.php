<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'emploi_fonctionnel' table. 
	...
	*/
	...
	function emploi_fonctionnel_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function emploi_fonctionnel_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function emploi_fonctionnel_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre_emploifct'], $data['grade'], $data['echelon'], $data['description']
	...
	*/
	...
	function emploi_fonctionnel_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function emploi_fonctionnel_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function emploi_fonctionnel_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_ef'], $data['titre_emploifct'], $data['grade'], $data['echelon'], $data['description']
	...
	*/
	...
	function emploi_fonctionnel_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function emploi_fonctionnel_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function emploi_fonctionnel_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function emploi_fonctionnel_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function emploi_fonctionnel_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function emploi_fonctionnel_batch_actions(&$args){
