<?php
	...
	*/
	 ...
	 *     $data['nom_du_client'], $data['nom_du_contact'], $data['titre_du_contact'], $data['adresse_postale'], $data['ville'], $data['code_postal'], $data['adresse_gm'], $data['pays'], $data['telephone_contact'], $data['email'], $data['commentaires']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_client'], $data['nom_du_client'], $data['nom_du_contact'], $data['titre_du_contact'], $data['adresse_postale'], $data['ville'], $data['code_postal'], $data['adresse_gm'], $data['pays'], $data['telephone_contact'], $data['email'], $data['commentaires']
