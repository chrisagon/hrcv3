<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'curriculum_vitae' table. 
	...
	*/
	...
	function curriculum_vitae_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function curriculum_vitae_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function curriculum_vitae_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['du_consultant'], $data['Titre_du_cv']
	...
	*/
	...
	function curriculum_vitae_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['du_consultant'], $data['Titre_du_cv'], $data['creer_par']
	...
	*/
	...
	function curriculum_vitae_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function curriculum_vitae_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_cv'], $data['du_consultant'], $data['Titre_du_cv'], $data['creer_par']
	...
	*/
	...
	function curriculum_vitae_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function curriculum_vitae_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function curriculum_vitae_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function curriculum_vitae_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function curriculum_vitae_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function curriculum_vitae_batch_actions(&$args){
