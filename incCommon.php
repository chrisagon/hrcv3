	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = array(
			...
			'consultant' => array('Dossier Consultant', 'Fiche contact du consultant', 'resources/table_icons/administrator.png', 'Accueil'),
			...
			'feedback' => array('Feedback', 'Merci d\'utiliser cette fiche de remarque pour nous permettre d\'am&#233;liorer cette application', 'resources/table_icons/bulb.png', 'Accueil'),
			'emploi_fonctionnel' => array('Emploi fonctionnel', '', 'table.gif', 'R&#233;ferentiel'),
			'tags' => array('Tags', '', 'table.gif', 'Liste')
		);
	...
	function get_table_groups($skip_authentication = false) {
		...
		$all_groups = array('Accueil', 'Votre CV', 'Liste', 'R&#233;ferentiel');
